...
const usageCode = `import WavyTextSlideUpButton from "@/components/ui/wavy-text-slideup-button";

const App = () => {
  return (
    <WavyTextSlideUpButton size={"default"}>Get the font</WavyTextSlideUpButton>
  )
}
...
const WavyButtonsPage = () => {
  const tsCode = readFileAsString(
    path.resolve("./src/components/buttons/wavy-text-slideup-button.tsx"),
  );
  const jsCode = readFileAsString(
    path.resolve("./src/lib/code/wavy-text-slideup-button.jsx"),
  );
  ...
  return (
    <div>
      ...
      <div className="grid place-items-center gap-10 rounded-md bg-white py-10">
        <WavyTextSlideUpButton size={"sm"}>Get the font</WavyTextSlideUpButton>
        <WavyTextSlideUpButton>Get the font</WavyTextSlideUpButton>
        <WavyTextSlideUpButton size={"lg"}>Get the font</WavyTextSlideUpButton>
      </div>
      ...
      <CodeViewer
        jsCode={jsCode}
        tsCode={tsCode}
        filePath="components/ui/wavy-text-slideup-button.tsx"
      />
    </div>
  );
};

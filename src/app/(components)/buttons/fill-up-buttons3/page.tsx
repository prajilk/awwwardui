...
const usageCode = `import FillUpButton3 from "@/components/ui/fill-up-button3";

const App = () => {
  return (
    <FillUpButton3 size={"default"}>Check this out</FillUpButton3>
  )
}
...
const WavyButtonsPage = () => {
  const tsCode = readFileAsString(
    path.resolve("./src/components/buttons/fill-up-button3.tsx"),
  );
  const jsCode = readFileAsString(
    path.resolve("./src/lib/code/fill-up-button3.jsx"),
  );
  ...
  return (
    <div>
      ...
      <div className="grid place-items-center gap-10 rounded-md bg-white py-10">
        <FillUpButton3 size={"icon"}>
          <ArrowDown />
        </FillUpButton3>
        <FillUpButton3 size={"sm"}>Check this out</FillUpButton3>
        <FillUpButton3>Check this out</FillUpButton3>
        <FillUpButton3 size={"lg"}>Check this out</FillUpButton3>
      </div>
      ...
      <CodeViewer
        jsCode={jsCode}
        tsCode={tsCode}
        filePath="components/ui/fill-up-button3.tsx"
      />
    </div>
  );
};

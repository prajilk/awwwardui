...
const SideNav = ({ children }: PropsWithChildren) => {
  ...
  return (
    <nav className="flex">
      ...
      ></div>
      <div
        className={`${show ? "translate-x-0" : "-translate-x-full"} fixed z-50 h-screen w-4/5 space-y-2 bg-neutral-900 p-5 transition-transform duration-300 lg:static lg:w-1/4 lg:translate-x-0`}
      >
